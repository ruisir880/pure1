...
function PCAS() {
    ...
    this.SelP.onchange = function() {
        ...
        //document.getElementById("proh").value=document.getElementById("province").value;
        setCookie('papa_province',document.getElementById("province").value,365);
        document.getElementById("proh").value=getCookie('papa_province');
    };
    ...
    if (this.SelC) this.SelA.onchange = function() {
        //alert(document.getElementById("area").value);
        //document.getElementById("areah").value=document.getElementById("area").value;
        setCookie('papa_area',document.getElementById("area").value,365);
        document.getElementById("areah").value=getCookie('papa_area');
    };
    PCAS.SetP(this)
};
...
PCAS.SetC = function(PCA) {
    ...
    PCA.SelC.length = 0;
    /*if(PI!=0)*/ PCA.SelC.options.add(new Option(SCT, ""));
...
PCAS.SetA = function(PCA) {
    ...
    PCA.SelA.length = 0;
    /*if(PI!=0)*/ PCA.SelA.options.add(new Option(SAT, ""));
    ...
    //alert(PCAA[PI][CI][0]);
    //document.getElementById("cityh").value=PCAA[PI][CI][0];
    //document.getElementById("areah").value=PCAA[PI][CI][1];
    //alert(PCAAT);
    //alert(PCAA[PI][CI][1]);

    setCookie('papa_city',PCAA[PI][CI][0],365);
    setCookie('papa_area',PCAA[PI][CI][1],365);
    document.getElementById("cityh").value=getCookie('papa_city');
    document.getElementById("areah").value=getCookie('papa_area');
};
